...
class Solver {
  public:
    ...
    These will store the strictly lower and strictly upper parts of the factorization.

    Why D_factor_vals? 
    The U factor from an LU decomposition is not unit-diagonal; its diagonal contains the pivots. 
    We will store this diagonal separately, just like we do for the Jacobi preconditioner. 
    L_factor will be strictly lower triangular.
    */
