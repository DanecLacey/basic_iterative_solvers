...
DEFINE_SOLVER_TEST(test_gmres_with_ilu0_precond, GMRESSolver, SolverType::GMRES, PrecondType::ILU0)
...
struct RegisterSolverTests {
    RegisterSolverTests() {
        ...
        register_test("Solvers::GMRESWithILU0Precond", test_gmres_with_ilu0_precond);
    }
};
