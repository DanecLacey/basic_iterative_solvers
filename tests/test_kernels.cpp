...
void test_apply_preconditioner() {
    ...
    std::vector<double> D = {2.0, 3.0, 4.0};
    std::vector<double> D_inv = {1 / 2.0, 1 / 3.0, 1 / 4.0};
    ...
    // Test Jacobi
    apply_preconditioner(PrecondType::Jacobi, N, nullptr, nullptr, nullptr,
                         nullptr, D.data(), D_inv.data(), vec.data(),
                         rhs.data(), nullptr, nullptr);
    for (int i = 0; i < N; ++i)
    ...
    // Test GaussSeidel
    {
        ...
        apply_preconditioner(PrecondType::GaussSeidel, N, &L_strict, nullptr,
                             nullptr, nullptr, D.data(), D_inv.data(),
    ...
    // Test BackwardsGaussSeidel
    {
        ...
        apply_preconditioner(PrecondType::BackwardsGaussSeidel, N, nullptr,
                             &U_strict, nullptr, nullptr, D.data(),
                             D_inv.data(), vec.data(), b_bgs.data(), nullptr,
                             nullptr);
        for (int i = 0; i < N; ++i)
