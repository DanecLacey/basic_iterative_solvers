...
// <<< NEW OVERLOADED FUNCTION FOR ILU >>>
// Computes z <- M^{-1}y where M = LU
inline void apply_preconditioner(const MatrixCRS* L_factor, const MatrixCRS* U_factor, double* D_factor,
